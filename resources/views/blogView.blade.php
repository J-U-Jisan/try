...
<section class="section-padding" style="background: #F1F4F6">
    ...
    <div class="w-75">
        ...
        <div class="mt-4 float-right row">
            ...
            <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u={{ route('blog.view',[$post->id]) }}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text={{ $post->title }}&amp;url={{ route('blog.view',[$post->id]) }}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="mailto:?subject={{ $post->title }}&amp;body={{ route('blog.view',[$post->id]) }}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('blog.view',[$post->id]) }}&amp;title={{ $post->title }}&amp;summary={{ $post->title }}&amp;source={{ route('blog.view',[$post->id]) }}" target="_blank" rel="noopener" aria-label="">
            ...
            <a class="resp-sharing-button__link" href="whatsapp://send?text={{ $post->title }}.%20{{ route('blog.view',[$post->id]) }}" target="_blank" rel="noopener" aria-label="">
